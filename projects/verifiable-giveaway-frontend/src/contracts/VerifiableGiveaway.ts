...
export type VerifiableGiveaway = {
  ...
  state: {
    global: {
      randomnessBeaconId?: IntegerState
      safetyGap?: IntegerState
    }
    local: {
...
export class VerifiableGiveawayClient {
   ...
   */
  public async getGlobalState(): Promise<VerifiableGiveaway['state']['global']> {
    const state = await this.appClient.getGlobalState()
    return {
      get randomnessBeaconId() {
        return VerifiableGiveawayClient.getIntegerState(state, 'randomness_beacon_id')
      },
      get safetyGap() {
        return VerifiableGiveawayClient.getIntegerState(state, 'safety_gap')
      },
    }
  }
