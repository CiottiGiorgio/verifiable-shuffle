...
MIN_WINNERS: Final[str] = "There must be at least one winner"
MIN_PARTICIPANTS: Final[str] = "There must be at least two participants"
INPUT_SOUNDNESS: Final[str] = "Participants must be less than or equal to Winners"
