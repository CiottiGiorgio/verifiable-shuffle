...
By the default the template creates a single `HelloWorld` contract under verifiable_giveaway folder in the `smart_contracts` directory. To add a new contract:
